...
Kappes Office is a modular, scalable Flutter application for office management, e-commerce, and user engagement. The app uses GetX for state management and routing, and is structured for maintainability and extensibility.
...
- **Wishlist and Saved Products** (recently added)
- **Product Card Widget** (recently improved with wishlist toggle and navigation)
- **Refactored modules for scalability**
...
lib/
  ...
  app/
    ...
    widgets/               # Shared widgets (e.g., ProductCard, AppImage)
assets/
  app_logo/                # App logos
...
- **saved/**: Wishlist and saved/favorite items (recently improved)
- **trades_services/**: Trades and services listings
- **error_screens/**: Error and fallback screens
- **bottom_nav/**: Bottom navigation bar

## Recent Updates
- Improved **ProductCard** widget with wishlist toggle and navigation to product details.
- Enhanced **saved** module for wishlist management.
- Refactored project structure for better scalability.
- Updated UI and added new screenshots.
...
<img width="278" height="650" alt="Screenshot 2025-07-18 162209" src="https://github.com/user-attachments/assets/0aa05610-4eb1-42f6-92cc-cffa32677e86" />
