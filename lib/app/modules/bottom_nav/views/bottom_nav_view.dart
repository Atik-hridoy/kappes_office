...
class BottomNavView extends GetView<BottomNavController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() => _buildSelectedPage(controller, context)),
            ...
            destinations: [
              const NavigationDestination(
                icon: ColorFiltered(
                  ...
                  child: ImageIcon(AssetImage(AppIcons.home), size: 24.0),
                ),
              ...
              const NavigationDestination(
                icon: ColorFiltered(
                  colorFilter: ColorFilter.mode(Colors.black, BlendMode.srcIn),
                  child: ImageIcon(AssetImage(AppIcons.message), size: 24.0),
                ),
                selectedIcon: ColorFiltered(
                  colorFilter: ColorFilter.mode(
                    AppColors.white,
              ...
              const NavigationDestination(
                icon: ColorFiltered(
                  colorFilter: ColorFilter.mode(Colors.black, BlendMode.srcIn),
                  child: ImageIcon(AssetImage(AppIcons.favourite), size: 24.0),
                ),
                selectedIcon: ColorFiltered(
                  colorFilter: ColorFilter.mode(
                    AppColors.white,
              ...
              const NavigationDestination(
                icon: ColorFiltered(
                  colorFilter: ColorFilter.mode(Colors.black, BlendMode.srcIn),
                  child: ImageIcon(AssetImage(AppIcons.category), size: 24.0),
                ),
                selectedIcon: ColorFiltered(
                  colorFilter: ColorFilter.mode(
                    AppColors.white,
              ...
              const NavigationDestination(
                icon: ColorFiltered(
                  colorFilter: ColorFilter.mode(Colors.black, BlendMode.srcIn),
                  child: ImageIcon(AssetImage(AppIcons.person), size: 24.0),
                ),
                selectedIcon: ColorFiltered(
                  colorFilter: ColorFilter.mode(
                    AppColors.white,
