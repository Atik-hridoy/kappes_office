...
import 'package:canuck_mall/app/data/netwok/message/create_messages_service.dart';
...
class MessagesBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<CreateChatToSellerService>(() => CreateChatToSellerService());  // Register CreateChatService first
    Get.lazyPut<GetMessageService>(() => GetMessageService());  // Register GetMessageService for fetching messages
    Get.lazyPut<CreateMessageService>(() => CreateMessageService());  // Register CreateMessageService for sending messages
    
    // Now register controllers that depend on the services
    Get.lazyPut<MessagesController>(() => MessagesController());
    Get.lazyPut<ChattingViewController>(() => ChattingViewController(
      chatService: Get.find<CreateChatToSellerService>(),  // Inject CreateChatService
